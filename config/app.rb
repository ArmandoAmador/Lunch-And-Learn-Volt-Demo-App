Volt.configure do |config|
  ...
  #######################################
  config.domain = 'demo-app.com'
  config.app_name = 'Demo-app'
  config.mailer.from = 'Demo-app <no-reply@demo-app.com>'
  ...
  #
  config.app_secret = 'LFf8HeByYOGnyKuE2mUBWhtvpvI-sH7ezDkPg466qu-GHwpJ4ETJQgOhCjG8sjnx-OY'
